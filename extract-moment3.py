...
def _extract_eig(
    ...
    # Eigenvectors of matting laplacian matrix
        ...
        if image_color_lambda > 0:
            ...
            if moment=='kor':
                resmom = calculate_kurtosis(patches,num_rows,num_cols)
            elif moment=='std':
        ...
        # Combine
        W_comb = (feat_lambda * W_feat) + (W_color * image_color_lambda)  # combination
...
def extract_eigs(
    ...
    kwargs = dict(K=K, which_matrix=which_matrix, which_features=which_features, which_color_matrix=which_color_matrix,
                 ...
                 image_downsample_factor=image_downsample_factor, image_color_lambda=image_color_lambda, lapnorm=lapnorm,moment=moment,feat_lambda=feat_lambda)
    print(kwargs)
